...
game_images = {}
framepersecond = 32
pipeimage = 'images/vector2.png'
background_image = 'images/minions1.jpg'
birdplayer_image = 'images/gru1.png'
sealevel_image = 'images/minions.png'
...
def flappygame():
	...
	down_pipes = [
		{'x': window_width+200-mytempheight,
		'y': first_pipe[1]['y']},
	...
	while True:
		...
		if game_over:
			return
		#The isGameOver funciton checks to see if you touched a pipe or the top or bottom ranges
		#if you did then you are returned to the start
